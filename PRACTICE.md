...
Rows previously labelled «Zhao et al., arXiv Sep 2026» and «Gupta & Morales,
IEEE TPWRS Sep 2026» are **withdrawn**: no stable identifier was given
(placeholder ``10.1109/TPWRS``, no arXiv id). A real LLM→solver paper
(Zhao & Hu, [arXiv:2508.08147](https://arxiv.org/abs/2508.08147)) is unit
commitment, not ТОиР GridPlan, and is **not** in the CLI twin.
