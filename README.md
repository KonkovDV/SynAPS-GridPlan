...
0.1.7 добивает лабораторные закрытия 0.1.6: native nested ``deny_unknown_fields``,
квота чтения по прочитанным байтам, sanitizer Markdown, jsonschema-инвентарь.
...
`version` должен напечатать `0.1.7` и пин `6178c93…`. Если `source` указывает
