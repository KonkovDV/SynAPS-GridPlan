...
Synthetic fixtures only. Committed markdown:

| File | What it is |
| --- | --- |
| `jury_report.md` | checked campaign-shaped demo, RES Severny (55 jobs) |
| `emergency_day_report.md` | synthetic restoration day, uzel Vostochny |
